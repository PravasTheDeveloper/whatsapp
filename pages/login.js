...
function login() {
    ...
    const emailPassLogin = () =>{
        const singInEmial = signInWithEmailAndPassword(auth,email,password).
        then((result) =>{
            alert("Welcome")
            if(singInEmial){
                Router.push("/")
                ...
                <div className='LoginBox bg-white rounded-lg shadow'>
                    <div className='h-full w-full p-20 pt-10'>
                        ...
                        <div className='w-full'>
                            ...
                            <div>
                                <button onClick={emailPassLogin} className="bg-emerald-500 w-full text-white py-1 mb-5">Login</button>
                            </div>
                            <div className='mb-5'>
                        ...
                        <div className='flex mb-5 justify-center'>
                            <div className='mx-5'>
                                <img src="GoogleLogin.png" className='SocialMediaLogin' onClick={GoogleLogin} alt="Google Login Icon" />
                            </div>
                            <div className='mx-5'>
                                <img src="FacebookLogin.png" className='SocialMediaLogin' alt="Facebook Login Icon" />
                            </div>
                        </div>
                        <div>
                            <p className='font-semibold text-md'>Don't Have Any Account ? <span className='text-emerald-500'><Link href="/signup"> Sign Up</Link></span></p>
                        </div>
                    </div>
                </div>
            </div>
